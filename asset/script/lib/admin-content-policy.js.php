...
quill.on('text-change',()=>{
    ...
    localStorage.setItem('quill-delta-policy', JSON.stringify(delta));
})
const saved = localStorage.getItem('quill-delta-policy');
if(saved){
...
function formreset(){
    console.log('reset');
    localStorage.setItem('quill-delta-policy', '');
    location.reload();
}
</script>