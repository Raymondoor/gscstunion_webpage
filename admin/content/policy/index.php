...
pageconfig([
    'TITLE' => '各種方針 | 管理 | '.APP_NAME,
    'INDEX' => 'admin-content-policy',
    'ALIAS' => '各種方針'
]);
...
<input type="hidden" required name="type" id="type" value="policy">
<div id="quillWrapper"><div id="editor">
    <?php @include_once(DATA_DIR.'/content/policy.html');?>
</div></div>
